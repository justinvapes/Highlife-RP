...
function F_02668(arg1, locationReference)
    DisplayHelpText("~INPUT_ATTACK~ to target selection~n~~INPUT_FRONTEND_CANCEL~ to abort hack")
            ...
            for i = 1, #Dat_2, 1 do
                if Dat_2[i].val3 == 1 then
                    if Dat_2[i].val2 < 1.0 then
                        Dat_2[i].val2 = Dat_2[i].val2 + ((Dat_2[i].val1 * Timestep()) * (arg1 * (6 * 1.0)))
                    else
                        Dat_2[i].val3 = 0
                    end
    ...
    Citizen.CreateThread(function()
        ...
        while true do
            ...
            if Dat_2[1].val4 == false and Dat_2[2].val4 == false and Dat_2[3].val4 == false and Dat_2[4].val4 == false and Dat_2[5].val4 == false and Dat_2[6].val4 == false and Dat_2[7].val4 == false then
                ...
                TriggerEvent("HighLife:Robberies:Datacrack", true, locationReference)
...
function DataCrackAbort()
    stophack = true

    TriggerEvent("HighLife:Robberies:Datacrack", false)
end

function DataCrackStart(arg1, reference)
    local loc1
    if arg1 == nil then
        loc1 = 25
    elseif arg1 < 2 then
