    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() then
            ...
            if Hovered and Selected then
                RageUI.PlaySound(RageUI.Settings.Audio[RageUI.Settings.Audio.Use].Slider.audioName, RageUI.Settings.Audio[RageUI.Settings.Audio.Use].Slider.audioRef, true)
            end
