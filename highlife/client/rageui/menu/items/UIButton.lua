        ...
        if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
            ...
            if Enabled then
                ...
                if Style.RightLabel then
                    ...
                    if Style.Color ~= nil and Style.Color.LabelColor ~= nil then
                        LabelColor = Style.Color.LabelColor
                    end

                    RenderText(Style.RightLabel, CurrentMenu.X + SettingsButton.RightText.X - RightBadgeOffset + CurrentMenu.WidthOffset, CurrentMenu.Y + SettingsButton.RightText.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, SettingsButton.RightText.Scale, Active and 0 or LabelColor.R, Active and 0 or LabelColor.G, Active and 0 or LabelColor.B, 255, 2)
                end
