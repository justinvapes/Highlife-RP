webpackJsonp([0], [, , , , , , function(t, e, n) {
    ...
    var a = n(21),
        ...
        f = 365 * l,
        d = {
            fr_FR: ["just now", ["%s second ago", "%s seconds ago"],
    ...
    var v = {
        ...
        g = {
            ...
            resetPhone: function(t) {
                var e = t.dispatch,
                    n = t.getters;
                e("setZoon", "60%"), e("setVolume", 1), e("setBackground", n.config.background_default), e("setCoque", n.config.coque_default), e("setLanguage", "en_US")
            }
        },
        _ = {
    ...
    e.default = {
        ...
        watch: {
            appelsInfo: function(t, e) {
                if (null !== this.appelsInfo && !0 !== this.appelsInfo.is_accepts ? (null !== this.soundCall && this.soundCall.pause(), !0 === this.appelsInfo.initiator ? this.soundCall = new Audio("/html/static/sound/Phone_Call_Sound_Effect.ogg") : this.soundCall = new Audio("/html/static/sound/ring2.ogg"), this.soundCall.loop = !0, this.soundCall.volume = this.volume, this.soundCall.play()) : null !== this.soundCall && (this.soundCall.pause(), this.soundCall = null), null === t && null !== e) return void this.$router.push({
                    name: "home"
                });
        ...
        methods: {
            onSelect: function(t) {
                ...
                !0 !== this.ignoreControls && (this.ignoreControls = !0, l.a.CreateModal({
                    ...
                    e.ignoreControls = !1, "Cancel" !== t.title && (e.$phoneAPI.callEvent(t.eventName, t.type), e.$router.push({
                        name: "home"
                    }))
                }))
            }
    ...
    e.default = {
        ...
        methods: l()({}, n.i(h.a)(["setMessageRead", "sendMessage", "deleteMessage", "startCall"]), {
            ...
            onActionMessage: function(t) {
                var e = this;
                var thisNumber = t.message.match(/\d{3}-\d{4}/);

                var finalPhoneNumber = thisNumber[0];
                        ...
                        for (;;) switch (n.prev = n.next) {
                            case 0:
                                return n.prev = 0, s = /(-?\d+(\.\d+)?), (-?\d+(\.\d+)?)/.test(t.message), i = /#([0-9]+)/.test(t.message), r = e.isSMSImage(t), c = [{
                                    ...
                                    id: "num",
                                    title: e.IntlString("APP_MESSAGE_MESS_NUMBER"),
    ...
    e.default = {
        ...
        computed: l()({}, n.i(h.b)(["IntlString", "useMouse", "myPhoneNumber", "backgroundLabel", "coqueLabel", "zoom", "config", "volume", "availableLanguages"]), {
            paramList: function() {
